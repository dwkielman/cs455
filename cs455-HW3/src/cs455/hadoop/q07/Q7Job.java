...
public class Q7Job {
	...
	public static void main(String[] args) throws Exception {
		try {
	        ...
	        MultipleInputs.addInputPath(job, p1, TextInputFormat.class, Q7AnalysisMapper.class);
	        MultipleInputs.addInputPath(job, p2, TextInputFormat.class, Q7MetadataMapper.class);
