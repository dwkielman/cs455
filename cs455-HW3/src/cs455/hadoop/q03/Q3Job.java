...
public class Q3Job {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
	        ...
	        MultipleInputs.addInputPath(job, p1, TextInputFormat.class, Q3AnalysisMapper.class);
	        MultipleInputs.addInputPath(job, p2, TextInputFormat.class, Q3MetadataMapper.class);
